...
- 不写同人,不接着任何人的书往下写。
- 不借用任何源作品的人物、组织、设定、专名、桥段或源近句式。
- 不靠悲伤道具堆表面——没有缺口的人物,雨下得再大也不疼。

最终 skill 与它写出的每一个字,都做到**零原文摘录(quote-free)**。边界见 [`references/safety-and-boundary.md`](references/safety-and-boundary.md)。
